...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value='Select statistics', style={'width': '80%', 'padding': '3px', 'font-size': '20px', 'text-align-last': 'center'},
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Average monthly automobile sales'))
